package scenes
{
    ...
    public class TextureScene extends Scene
    {
        public function TextureScene()
        {
            ...
            var image1:ImageStarling = new ImageStarling(Game.assets.getTexture("flight_00"));
            image1.x = -20;
            image1.y = 0;
            addChild(image1);
            
            var image2:ImageStarling = new ImageStarling(Game.assets.getTexture("flight_04"));
            image2.x = 90;
            image2.y = 85;
            addChild(image2);
            
            var image3:ImageStarling = new ImageStarling(Game.assets.getTexture("flight_08"));
            image3.x = 100;
            image3.y = -60;
            addChild(image3);
            ...
            try
            {
                ...
                var compressedTexture:TextureStarling = Game.assets.getTexture("compressed_texture");
                var image:ImageStarling = new ImageStarling(compressedTexture);
            ...
            catch (e:Error)
            {
                ...
                var textField:TextFieldStarling = new TextFieldStarling(220, 128,
